...
function render_portal($container) {
	...
	frappe.call({
		method: "enviro.enviro.api.mobile_api.get_driver_context",
		callback: (r) => {
...
function fetch_and_render_jobs($container, context) {
	frappe.call({
		method: "enviro.enviro.api.mobile_api.get_assigned_jobs",
		callback: (r) => {
...
window.update_job = function (job_name, action) {
	frappe.call({
		method: "enviro.enviro.api.mobile_api.update_job_status",
